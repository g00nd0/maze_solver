...
public class maze_solver {
    ...
    private static ArrayList<Maze> readMazes() throws FileNotFoundException {   //separate method to refactor the parsing of maze from text file
        ...
        while(in.hasNext()){
            ...
            in.nextLine(); //from txt file, end of set of data has a space
